...
from secret_key import LLM_openai
from langchain.llms import HuggingFaceHub
import os
import tiktoken
from htmlTemplate import css, bot_template, user_template

openai_api_key = os.environ.get("LLM_openai")
Hugging_api_key =  os.environ.get("LLM_hugging_face")
...
def main():
    ...
    st.header("PDF-AI BOT : AI-Powered Conversations with your Multi-Document")
